...
public class ServerThread extends Thread {
    ...
    public boolean sendFile(String clientName, String fileMetadata) {
		Payload payload = new Payload();
		payload.setPayloadType(PayloadType.FILE);
		payload.setClientName(clientName);
		payload.setMessage(fileMetadata);
		return sendPayload(payload);
    }
	...
	case MESSAGE:
	    ...
	    break;
	case FILE:
	    currentRoom.sendFile(this, p.getMessage());
	    break;
	default:
