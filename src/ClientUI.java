...
public class ClientUI extends JFrame implements Event {
	...
	void addMessage(String str,boolean isfile) {
		...
		entry.setText(str);
                if(isfile){
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        try {
                            r.exec("notepad "+System.getProperty("user.dir")+"\\"+str.substring(str.indexOf('\'')+1,str.lastIndexOf('\'')));
	...
	@Override
	public void onFileReceive(String clientName, String fileName) {
		log.log(Level.INFO, String.format("%s: sent file with name '%s'", clientName, fileName));		
		self.addMessage(String.format("%s: sent file with name '%s'", clientName, fileName),true);
	}
